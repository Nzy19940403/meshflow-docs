...
[MeshFlow Core API](../../../README.md) / [engine/useEngineManager](../README.md) / useScheduler

# Function: useScheduler()

> **useScheduler**\<`T`, `P`, `B`, `NM`\>(`config`, `dependency`, `history`, `hooks`, `UITrigger`): `object`

Defined in: [engine/useScheduler.ts:8](https://github.com/Nzy19940403/meshflow/blob/31d0736a20e62927e2bd9b4877bcced689822f29/utils/core/engine/useScheduler.ts#L8)
